...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" type="text/css" href="{{ asset('adminka/css/normalize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('adminka/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('adminka/css/font-awesome.min.css') }}">
